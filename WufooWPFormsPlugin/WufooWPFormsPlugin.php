...
class WufooWPFormsPlugin {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'wufoo-wp-forms-plugin';
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_plugins_page(
			__( 'Wufoo Wordpress Forms Plugin', $this->plugin_slug ),
			__( 'Wufoo Forms Plugin', $this->plugin_slug ),
			'read',
			$this->plugin_slug,
